...
int
readInFile (string fileName, map & bMap)
{
  ifstream readin;
...
int
pDirectBus (map & a_map)
{
  cout << "Please enter a town number (0.." << (a_map.getTown ()->size () -
						1) << "):\n";
